...
fn parse_email_message(raw: &str) -> EmailMsg {
    ...
    for (name, val) in &headers {
        ...
        match lname.as_str() {
            ...
            "x-gmail-labels" => msg.labels = Some(decoded),
            "received" => {
...
fn decode_text_charset(bytes: &[u8], content_type: &str) -> String {
    ...
    // Best-effort: lossily decode as UTF-8 — most modern Gmail bodies are UTF-8 anyway.
